...
/*
    Fazer a leitura de quatro valores numéricos inteiros representados
    pelas variáveis a, b, c e d. Apresentar apenas os valores que
    sejam divisiveis por 2 e 3.
*/
fun main() {
